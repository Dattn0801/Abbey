    ...
    public class SummaryModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            if (claim != null)
            {
                ...
                //Proxy o day
                ProxyOrderHeader proxy = new ProxyOrderHeader(OrderHeader);
                if (proxy.checkTime() == Result.InValid)
                {
                    TempData["messageinvalid"] = "Time Date is invalid";
                    return Page();
                }
                else
                {
        ...
        public IActionResult CheckTimeOrderHeader(OrderHeader order)
        {
            return OnPost();
        }
    }
